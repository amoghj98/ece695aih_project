...
def timeAggregator(approach, filePath='./logs/', cpuOverhead=0.5, coolingOverhead=0.2):
    filePath += approach
...
if __name__ == "__main__":
    t = 0
    t += timeAggregator('vanilla')
    # t += timeAggregatorAggregator('bs_4')
    # t += timeAggregatorAggregator('bs_16')
    # t += timeAggregator('bs_64')
   # t += timeAggregator('bs_256')
